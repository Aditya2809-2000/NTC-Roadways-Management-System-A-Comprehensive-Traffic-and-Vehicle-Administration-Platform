...
SELECT * FROM Vehicle JOIN Incident NATURAL LEFT JOIN People  WHERE Vehicle_licence like 'LB15AJL';
...
INSERT INTO Ownership (People_ID, Vehicle_ID) VALUES(21, 31);
...
CREATE TABLE People (
  ...
  People_licence Peoplevarchar(16) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
