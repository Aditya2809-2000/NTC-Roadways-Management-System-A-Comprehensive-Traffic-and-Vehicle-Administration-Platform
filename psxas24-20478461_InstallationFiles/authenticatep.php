    ...
    if (empty($username)) {
        ...
        if (mysqli_num_rows($result) == 1) {
            ...
            if ($row['username'] == $username && $row['password'] == $password) {
                ...
                header("Location: index_p.php?error=Incorrect User name or password1");
            ...
            header("Location: index_p.php?error=Incorrect User name or password2");
